...
import { Menu, Star, Clock, Layers, Gem, Sparkles, ChevronLeft, ChevronRight, VolumeX, Plus, ChevronDown, ChevronUp, Instagram, Linkedin, Twitter, ArrowRight } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <>
    <div className="min-h-screen w-full bg-zinc-50 p-3 md:p-5 flex flex-col font-sans">
      <div className="relative flex-1 w-full rounded-[2rem] overflow-hidden flex flex-col min-h-[80vh]">
        ...
        {/* Navigation */}
        <nav className="relative z-10 flex items-center justify-between px-6 py-6 md:px-12 border-b border-white/20">
          <div className="flex items-center gap-3 cursor-pointer group w-1/3">
            <Menu className="w-6 h-6 text-white group-hover:text-white/80 transition-colors" strokeWidth={1.5} />
            <span className="text-sm font-medium text-white group-hover:text-white/80 transition-colors hidden sm:block">
              Koleksi
            </span>
          </div>

          <div className="w-1/3 flex justify-center">
            <h1 className="text-2xl md:text-3xl font-bold tracking-widest uppercase text-white">
              SECERA
            </h1>
          </div>

          <div className="w-1/3 flex justify-end">
            <button className="px-6 py-2 text-sm font-medium border border-white text-white rounded-full hover:bg-white hover:text-black transition-all duration-300">
              Masuk
            </button>
          </div>
        </nav>
      ...
      {/* Product Section */}
      <div className="relative w-full rounded-[2rem] overflow-hidden bg-[#f8f8f6] mt-3 md:mt-5 pt-20 pb-6 px-4 md:px-6 flex flex-col items-center">
        <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-zinc-500 mb-4 relative z-10">
          KOLEKSI SECERA
        </span>
        <h2 className="text-4xl md:text-6xl font-serif text-[#1a2e25] mb-8 relative z-10">
          Timeless Elegance
        </h2>

        {/* Section Background Image */}
        <div className="absolute top-40 left-0 right-0 bottom-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-b from-[#f8f8f6] via-transparent to-[#f8f8f6]/50 z-10" />
          <img
      ...
      {/* Carousel Section */}
      <div className="w-full bg-white py-20 px-4 md:px-12 flex flex-col mt-3 md:mt-5 rounded-[2rem]">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-[#1a2e25] max-w-2xl leading-tight">
        ...
        >
          ...
          >
            <div className="bg-[#fcece3] rounded-[2rem] p-8 h-[450px] flex flex-col relative overflow-hidden transition-shadow duration-300 group-hover:shadow-xl">
              ...
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-48 h-64 bg-[#1a2e25] rounded-t-lg shadow-2xl flex items-center justify-center transition-transform duration-500 group-hover:scale-105 group-hover:-translate-y-2">
          ...
          <motion.div 
            ...
            className="carousel-card min-w-[300px] md:min-w-[400px] flex flex-col gap-6 snap-start cursor-pointer group"
          >
            <div className="bg-[#f4f3ef] rounded-[2rem] p-8 h-[450px] flex flex-col relative overflow-hidden transition-shadow duration-300 group-hover:shadow-xl">
        ...
        <div className="w-full max-w-md mx-auto mt-8 bg-zinc-200 rounded-full h-1.5 overflow-hidden">
          <div 
            className="bg-zinc-800 h-full transition-all duration-300 ease-out"
    ...
    <section className="py-24 px-6 md:px-12 max-w-[1600px] mx-auto bg-white">
      <div className="max-w-5xl mx-auto text-center mb-24">
        <motion.h2 
          ...
          className="text-2xl md:text-4xl lg:text-[40px] font-serif text-zinc-900 leading-snug md:leading-relaxed"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-16">
        {[
          ...
          >
            <div className="bg-[#f4f3ef] aspect-[4/5] mb-6 overflow-hidden relative">
              <img 
                src={product.image} 
                alt={product.name} 
    ...
    {/* UGC Video Section */}
    <section className="py-12 px-6 md:px-12 max-w-[1600px] mx-auto bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          >
            ...
            {/* Product Card */}
            <div className="bg-[#f4f3ef] flex relative group cursor-pointer h-28">
              <div className="w-28 h-full shrink-0 bg-[#ebebeb] p-3">
              ...
              <button className="absolute bottom-0 right-0 w-8 h-8 bg-[#5c8065] text-white flex items-center justify-center hover:bg-[#4a6b53] transition-colors">
    ...
    {/* FAQ Section */}
    <section className="py-24 px-6 md:px-12 max-w-3xl mx-auto bg-white w-full">
      <motion.h2 
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.7, ease: "easeOut" }}
        className="text-4xl md:text-5xl font-serif text-zinc-900 text-center mb-16"
      >
        FAQ
      </motion.h2>
    ...
    {/* Footer Section */}
    <footer className="bg-[#1a2e25] text-[#f4f3ef] pt-20 relative overflow-hidden mt-12">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Koleksi Baru</a>
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Signature Outer</a>
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Aksesoris</a>
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Ulasan Pelanggan</a>
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Panduan Ukuran</a>
          </div>
          
          <div className="lg:col-span-2 flex flex-col gap-4">
            <h4 className="font-bold text-lg mb-2">Tentang</h4>
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Tentang Kami</a>
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Jurnal</a>
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Karir</a>
            <a href="#" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors">Syarat & Ketentuan</a>
          </div>

          <div className="lg:col-span-3 flex flex-col gap-4">
            <h4 className="font-bold text-lg mb-2">Hubungi Kami</h4>
            <a href="mailto:care@secera.id" className="text-sm text-[#f4f3ef]/80 hover:text-white transition-colors mb-4">care@secera.id</a>
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#111e18] rounded-2xl p-8 lg:p-10 shadow-xl">
              <h3 className="text-2xl md:text-3xl font-serif mb-8 leading-snug">Dapatkan berita dan penawaran terbaru dari kami</h3>
              <div className="relative border-b border-[#f4f3ef]/30 pb-2 flex items-center">
                <input 
                  type="email" 
                  placeholder="Email" 
                  className="bg-transparent w-full outline-none text-[#f4f3ef] placeholder:text-[#f4f3ef]/50 pr-8 text-lg"
                />
                <button className="absolute right-0 hover:translate-x-1 transition-transform">
                  <ArrowRight className="w-6 h-6 text-[#f4f3ef]/70" />
                </button>
              </div>
            </div>
          </div>
        ...
        {/* Copyright */}
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-4 text-xs text-[#f4f3ef]/70 mb-8">
        ...
        <div className="h-px bg-[#f4f3ef]/20 w-full mb-8" />

        {/* Disclaimers */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 text-[10px] text-[#f4f3ef]/60 mb-16">
          ...
          <div className="md:col-span-5 border border-[#f4f3ef]/20 rounded-xl p-5">
      ...
      <div className="w-full overflow-hidden leading-none pt-4 flex justify-center items-end">
        <h1 className="text-[24vw] font-bold text-[#f4f3ef] leading-[0.72] tracking-tighter select-none">
          secera
        </h1>
      </div>
    </footer>
