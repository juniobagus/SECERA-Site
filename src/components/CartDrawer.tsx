      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-[#5A252D]/35 backdrop-blur-sm z-[60]"
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-full max-w-md bg-[#F9F9F9] z-[70] flex flex-col shadow-2xl"
          >
            {/* Header */}
